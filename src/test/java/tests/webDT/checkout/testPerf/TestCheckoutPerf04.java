 ...
 */
public class TestCheckoutPerf04 extends BaseTest {
    WebDriver driver;
    ExcelReader excelReaderDT2 = new ExcelReader(Config.getDataFile(Config.DT2_DETAILS));
    Logger logger = Logger.getLogger(TestCheckoutPerf04.class);
    ...
    public void regNavigateToBillingPage()throws Exception {
        ...
        Map<String, String> credentials = excelReaderDT2.getExcelData("PerfLogin", "User4");

        String keyWord = getDT2TestingCellValueBySheetRowAndColumn("Search", "SearchPerf2", "Value");
        String qty = getDT2TestingCellValueBySheetRowAndColumn("Search", "SearchPerf2", "Qty");
