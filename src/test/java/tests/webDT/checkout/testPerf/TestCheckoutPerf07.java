 ...
 */
public class TestCheckoutPerf07 extends BaseTest {
    WebDriver driver;
    ExcelReader excelReaderDT2 = new ExcelReader(Config.getDataFile(Config.DT2_DETAILS));
    Logger logger = Logger.getLogger(TestCheckoutPerf07.class);
    ...
    public void regNavigateToBillingPage()throws Exception {
        ...
        Map<String, String> credentials = excelReaderDT2.getExcelData("PerfLogin", "User7");

        String keyWord = getDT2TestingCellValueBySheetRowAndColumn("Search", "SearchPerf1", "Value");
        String qty = getDT2TestingCellValueBySheetRowAndColumn("Search", "SearchPerf1", "Qty");
