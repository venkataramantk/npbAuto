...
import ui.pages.repo.DomSearchOrderPageRepo;
 ...
 */
public class DomSearchOrderPageActions extends DomSearchOrderPageRepo {
    WebDriver driver;
    Logger logger = Logger.getLogger(DomSearchOrderPageActions.class);

    public DomSearchOrderPageActions(WebDriver driver){
        this.driver = driver;
        setDriver(driver);
