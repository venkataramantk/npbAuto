...
import ui.pages.repo.DomHomePageRepo;
 ...
 */
public class DomHomePageActions extends DomHomePageRepo {
    WebDriver driver;
    Logger logger = Logger.getLogger(DomHomePageActions.class);

    public DomHomePageActions(WebDriver driver) {
        this.driver = driver;
        setDriver(driver);
