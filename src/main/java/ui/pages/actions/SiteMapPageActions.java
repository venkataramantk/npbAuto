...
import ui.pages.repo.SiteMapPageRepo;
 ...
 */
public class SiteMapPageActions extends SiteMapPageRepo {
    WebDriver driver;
    Logger logger = Logger.getLogger(SiteMapPageActions.class);

    public SiteMapPageActions(WebDriver driver){
        this.driver = driver;
        setDriver(driver);
