 ...
 */
public class TestCheckoutPerf03 extends BaseTest {
    WebDriver driver;
    ExcelReader excelReaderDT2 = new ExcelReader(Config.getDataFile(Config.DT2_DETAILS));
    Logger logger = Logger.getLogger(TestCheckoutPerf03.class);
    ...
    public void regNavigateToBillingPage()throws Exception {
        ...
        Map<String, String> credentials = excelReaderDT2.getExcelData("PerfLogin", "User3");
